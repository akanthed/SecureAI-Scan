...
const EXPECTED_VULNERABLE = [
  ...
  ["MCP012", "vulnerable/mcp/.mcp.json"],
  ...
  // SKL008 — "Circus of Skills": fetch-and-follow a remote instruction source.
  ["SKL008", "vulnerable/skills/remote-instructions-skill/SKILL.md"],
  // SKL009 — cross-file persistence backdoor (ClawHavoc MEMORY.md/SOUL.md pattern).
  ["SKL009", "vulnerable/skills/memory-persist-skill/SKILL.md"],
  // SKL010 — unsafe YAML/JSON deserialization tag in a bundled config file.
  ["SKL010", "vulnerable/skills/unsafe-yaml-skill/config.yaml"],
  ...
  ["AI013", "vulnerable/structured_output_injection.ts"],
  ["AI014", "vulnerable/typesafe_confidence_gate.py"],
