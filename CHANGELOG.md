...
- **Independent security workflows.** CodeQL, dependency review, and OpenSSF Scorecard now run alongside the existing cross-platform CI. The project's own SecureAI-Scan workflow is blocking at high severity and uploads its report even on failure.
